...
import './globals.css';
const sans = IBM_Plex_Sans({ subsets:['latin','latin-ext','cyrillic'], weight:'500', variable:'--sans', display:'swap' });
const mono = IBM_Plex_Mono({ subsets:['latin','latin-ext','cyrillic'], weight:'400', preload:true, variable:'--mono', display:'swap' });
